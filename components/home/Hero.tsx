...
export function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-b from-brown via-brown-light to-cream"
    >
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-6 text-center text-ivory">
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.98 }}
          className="mt-10 inline-block rounded-full bg-gold px-8 py-3 text-sm font-medium tracking-wide text-ivory shadow-lg shadow-gold/20"
        >
          {t("cta")}
        </motion.a>
      </div>
      ...
      <motion.div
        ...
        className="absolute bottom-8 left-1/2 -translate-x-1/2 text-gold-light/70"
      >
        ↓
      </motion.div>
    </section>
